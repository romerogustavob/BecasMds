...
use BecasMds\PersonaBundle\Entity\Responsable;
use BecasMds\PersonaBundle\Form\ResponsableType;
use BecasMds\PersonaBundle\Form\ResponsableFilterType;
...
class ResponsableController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('PersonaBundle:Responsable')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        return $this->render('PersonaBundle:Responsable:show.html.twig', array(
            'entity'      => $entity,
