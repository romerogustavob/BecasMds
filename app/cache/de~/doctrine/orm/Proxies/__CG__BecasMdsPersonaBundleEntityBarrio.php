 ...
 */
class Barrio extends \BecasMds\PersonaBundle\Entity\Barrio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Barrio' . "\0" . 'id', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Barrio' . "\0" . 'nombre', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Barrio' . "\0" . 'domicilio', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Barrio' . "\0" . 'localidad', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Barrio' . "\0" . 'descripcion'];
        }
    ...
    public function getBarrioLista()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBarrioLista', []);

        return parent::getBarrioLista();
    }
