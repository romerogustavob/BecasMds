...
class TipoFuncion extends \BecasMds\BecaBundle\Entity\TipoFuncion implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoFuncion' . "\0" . 'id', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoFuncion' . "\0" . 'descripcion', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoFuncion' . "\0" . 'activo', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoFuncion' . "\0" . 'beca'];
        }
