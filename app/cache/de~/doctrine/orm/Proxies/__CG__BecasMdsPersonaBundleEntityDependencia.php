...
class Dependencia extends \BecasMds\PersonaBundle\Entity\Dependencia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Dependencia' . "\0" . 'id', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Dependencia' . "\0" . 'nombre', 'responsable', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Dependencia' . "\0" . 'detalle', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Dependencia' . "\0" . 'activo', 'becado'];
        }
