 ...
 */
class NivelEducativo extends \BecasMds\FormacionBundle\Entity\NivelEducativo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\FormacionBundle\\Entity\\NivelEducativo' . "\0" . 'id', '' . "\0" . 'BecasMds\\FormacionBundle\\Entity\\NivelEducativo' . "\0" . 'formacion', '' . "\0" . 'BecasMds\\FormacionBundle\\Entity\\NivelEducativo' . "\0" . 'descripcion'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NivelEducativo $proxy) {
