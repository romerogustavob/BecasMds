...
class Departamento extends \BecasMds\PersonaBundle\Entity\Departamento implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Departamento' . "\0" . 'id', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Departamento' . "\0" . 'nombre', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Departamento' . "\0" . 'domicilio', 'localidad', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Departamento' . "\0" . 'descripcion'];
        }
    ...
    public function addLocalidad(\BecasMds\PersonaBundle\Entity\Localidad $localidad)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addLocalidad', [$localidad]);
    ...
    public function removeLocalidad(\BecasMds\PersonaBundle\Entity\Localidad $localidad)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeLocalidad', [$localidad]);
