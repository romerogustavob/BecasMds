 ...
 */
class Terciario extends \BecasMds\FormacionBundle\Entity\Terciario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'carrera', 'nivel', 'formacion', 'institucion', 'tipoEducacion', 'titulo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Terciario $proxy) {
    ...
    public function setCarrera($carrera)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCarrera', [$carrera]);
    ...
    public function getTerciarioLista()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTerciarioLista', []);

        return parent::getTerciarioLista();
    }
