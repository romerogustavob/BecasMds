 ...
 */
class Oficio extends \BecasMds\FormacionBundle\Entity\Oficio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\FormacionBundle\\Entity\\Oficio' . "\0" . 'id', '' . "\0" . 'BecasMds\\FormacionBundle\\Entity\\Oficio' . "\0" . 'descripcion', '' . "\0" . 'BecasMds\\FormacionBundle\\Entity\\Oficio' . "\0" . 'formacion'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Oficio $proxy) {
