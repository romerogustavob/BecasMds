 ...
 */
class LugarAfectacion extends \BecasMds\PersonaBundle\Entity\LugarAfectacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\LugarAfectacion' . "\0" . 'id', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\LugarAfectacion' . "\0" . 'nombre', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\LugarAfectacion' . "\0" . 'descripcion', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\LugarAfectacion' . "\0" . 'becado'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LugarAfectacion $proxy) {
