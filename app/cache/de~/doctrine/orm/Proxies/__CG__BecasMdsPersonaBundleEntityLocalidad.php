...
class Localidad extends \BecasMds\PersonaBundle\Entity\Localidad implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Localidad' . "\0" . 'id', 'barrio', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Localidad' . "\0" . 'calle', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Localidad' . "\0" . 'domicilio', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Localidad' . "\0" . 'departamento', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Localidad' . "\0" . 'nombre', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Localidad' . "\0" . 'descripcion'];
        }
    ...
    public function addBarrio(\BecasMds\PersonaBundle\Entity\Barrio $barrio)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBarrio', [$barrio]);
    ...
    public function removeBarrio(\BecasMds\PersonaBundle\Entity\Barrio $barrio)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBarrio', [$barrio]);
    ...
    public function addCalle(\BecasMds\PersonaBundle\Entity\Calle $calle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCalle', [$calle]);
    ...
    public function removeCalle(\BecasMds\PersonaBundle\Entity\Calle $calle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCalle', [$calle]);
    ...
    public function getLocalidadLista()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLocalidadLista', []);
