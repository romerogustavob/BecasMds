    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/beca')) {
            ...
            if (0 === strpos($pathinfo, '/becavulnerable')) {
                ...
                // becavulnerable_new
                if ($pathinfo === '/becavulnerable/new') {
                    return array (  '_controller' => 'BecasMds\\BecaBundle\\Controller\\BecaVulnerableController::newAction',  '_route' => 'becavulnerable_new',);
                }

                // becavulnerable_create
                if ($pathinfo === '/becavulnerable/create') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_becavulnerable_create;
                    }

                    return array (  '_controller' => 'BecasMds\\BecaBundle\\Controller\\BecaVulnerableController::createAction',  '_route' => 'becavulnerable_create',);
                }
