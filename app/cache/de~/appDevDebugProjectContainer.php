...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/becado');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/certificacion');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/beca');

        $n = new \Symfony\Component\Security\Http\AccessMap();
        $n->add($g, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $n->add($h, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY', 1 => 'IS_ADMIN'), NULL);
        $n->add($i, array(0 => 'IS_USER IS_ADMIN'), NULL);
        $n->add($j, array(0 => 'ROLE_ADMIN'), NULL);
        $n->add($k, array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $n->add($l, array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $n->add($m, array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
