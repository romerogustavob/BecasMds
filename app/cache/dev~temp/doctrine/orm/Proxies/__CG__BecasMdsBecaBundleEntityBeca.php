...
class Beca extends \BecasMds\BecaBundle\Entity\Beca implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\Beca' . "\0" . 'id', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\Beca' . "\0" . 'monto', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\Beca' . "\0" . 'activo', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\Beca' . "\0" . 'fechaAlta', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\Beca' . "\0" . 'fechaBaja', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\Beca' . "\0" . 'tipoBeca', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\Beca' . "\0" . 'becadobeca', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\Beca' . "\0" . 'tipoFuncion'];
        }
