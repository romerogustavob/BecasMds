 ...
 */
class Profesion extends \BecasMds\FormacionBundle\Entity\Profesion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\FormacionBundle\\Entity\\Profesion' . "\0" . 'id', '' . "\0" . 'BecasMds\\FormacionBundle\\Entity\\Profesion' . "\0" . 'descripcion', '' . "\0" . 'BecasMds\\FormacionBundle\\Entity\\Profesion' . "\0" . 'formacion'];
        }
