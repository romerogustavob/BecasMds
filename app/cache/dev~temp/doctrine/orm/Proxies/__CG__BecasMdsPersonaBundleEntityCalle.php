 ...
 */
class Calle extends \BecasMds\PersonaBundle\Entity\Calle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Calle' . "\0" . 'id', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Calle' . "\0" . 'nombre', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Calle' . "\0" . 'domicilio', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Calle' . "\0" . 'localidad', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\Calle' . "\0" . 'descripcion'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Calle $proxy) {
    ...
    public function getCalleLista()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCalleLista', []);

        return parent::getCalleLista();
    }
