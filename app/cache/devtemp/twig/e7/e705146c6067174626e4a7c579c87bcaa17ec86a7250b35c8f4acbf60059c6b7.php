...
class __TwigTemplate_96dc8c826e04dfead7257c3e00d6bce29c37a3adfabd894bb9f7c0a51464677c extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("JordiLlonchCrudGeneratorBundle::layout.html.twig", "FormacionBundle:NivelEducativo:show.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("views.show.show", array("%entity%" => "Nivel Educativo"), "JordiLlonchCrudGeneratorBundle"), "html", null, true);
        echo "
";
    }
    ...
    public function block_page($context, array $blocks = array())
    {
        // line 8
        echo "
<h2 style=\"color: #0044cc\">Nivel Educativo</h2>
...
<div>
    ...
    <div class=\"float-left\">
        ...
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("niveleducativo_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
        echo "\">
            ";
        // line 29
...
";
    ...
    {
        return "FormacionBundle:NivelEducativo:show.html.twig";
    }
...
/* */
/* {% block title %}*/
/* {{ parent() }} - {{ 'views.show.show'|trans({'%entity%': 'Nivel Educativo'}, 'JordiLlonchCrudGeneratorBundle') }}*/
/* {% endblock %}*/
/* */
/* {% block page %}*/
/* */
...
/*     </div>*/
/*     <div class="float-left">*/
/*         <a class="btn btn-primary" href="{{ path('niveleducativo_edit', { 'id': entity.id }) }}">*/
