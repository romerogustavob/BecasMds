...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/usuario/hello') && preg_match('#^/usuario/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'usuario_homepage')), array (  '_controller' => 'BecasMds\\UsuarioBundle\\Controller\\DefaultController::indexAction',));
        }
        ...
        if ($pathinfo === '/registration') {
            return array (  '_controller' => 'BecasMds\\UsuarioBundle\\Controller\\UserController::registrationAction',  '_route' => 'registration',);
        }
