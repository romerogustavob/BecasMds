...
class TipoBeca extends \BecasMds\BecaBundle\Entity\TipoBeca implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoBeca' . "\0" . 'id', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoBeca' . "\0" . 'descripcion', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoBeca' . "\0" . 'detalle', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoBeca' . "\0" . 'activo', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoBeca' . "\0" . 'beca', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoBeca' . "\0" . 'createdBy', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoBeca' . "\0" . 'updatedBy', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoBeca' . "\0" . 'createdAt', '' . "\0" . 'BecasMds\\BecaBundle\\Entity\\TipoBeca' . "\0" . 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoBeca $proxy) {
