 ...
 */
class Universidad extends \BecasMds\FormacionBundle\Entity\Universidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'facultad', 'carrera', 'nivel', 'formacion', 'institucion', 'tipoEducacion', 'titulo'];
        }
    ...
    public function getUniversidadLista()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUniversidadLista', []);

        return parent::getUniversidadLista();
    }
