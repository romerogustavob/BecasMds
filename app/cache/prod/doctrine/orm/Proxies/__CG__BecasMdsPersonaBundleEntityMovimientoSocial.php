...
class MovimientoSocial extends \BecasMds\PersonaBundle\Entity\MovimientoSocial implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\MovimientoSocial' . "\0" . 'id', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\MovimientoSocial' . "\0" . 'nombre', 'referente', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\MovimientoSocial' . "\0" . 'observaciones', '' . "\0" . 'BecasMds\\PersonaBundle\\Entity\\MovimientoSocial' . "\0" . 'activo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MovimientoSocial $proxy) {
    ...
    public function addReferente(\BecasMds\PersonaBundle\Entity\Referente $referente)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addReferente', [$referente]);
    ...
    public function removeReferente(\BecasMds\PersonaBundle\Entity\Referente $referente)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeReferente', [$referente]);
