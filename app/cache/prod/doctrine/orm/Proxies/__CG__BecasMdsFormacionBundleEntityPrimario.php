 ...
 */
class Primario extends \BecasMds\FormacionBundle\Entity\Primario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'formacion', 'institucion', 'tipoEducacion', 'titulo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Primario $proxy) {
    ...
    public function getPrimarioLista()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPrimarioLista', []);

        return parent::getPrimarioLista();
    }
