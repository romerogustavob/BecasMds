 ...
 */
class Persona extends \BecasMds\PersonaBundle\Entity\Persona implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'dni', 'apellidos', 'nombres', 'telefono', 'email', 'formacion', 'domicilio', 'createdBy', 'updatedBy', 'createdAt', 'updatedAt'];
        }
