...
class appProdProjectContainer extends Container
{
    ...
    /*
     * Gets the 'antqa.form.type.ajax_auto_complete' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AntQa\AjaxAutoCompleteBundle\Form\Type\AjaxAutoCompleteType A AntQa\AjaxAutoCompleteBundle\Form\Type\AjaxAutoCompleteType instance.
     */
    protected function getAntqa_Form_Type_AjaxAutoCompleteService()
    {
        return $this->services['antqa.form.type.ajax_auto_complete'] = new \AntQa\AjaxAutoCompleteBundle\Form\Type\AjaxAutoCompleteType($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('font_awesome_ttf' => array(0 => array(0 => 'Web/bundles/jordillonchcrudgenerator/fonts/glyphicons-halflings-regular.ttf'), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.ttf')), 'images_login' => array(0 => array(0 => 'Web/bundles/beca/images/logoDesarrolloSocial-medium.jpg'), 1 => array(), 2 => array('output' => 'images/logoDesarrolloSocial-medium.jpg')), 'persona_jquery_ui' => array(0 => array(0 => 'Web/bundles/pesona/js/*.js'), 1 => array(), 2 => array('output' => 'js/jquery.ui.js')))), 'config');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'becasmds', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_af0bfce723c63f803242a06b7aff1dea78aedec38648a7b6bfd39173d4162b04');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'debug' => false, 'paths' => array()));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'antqa.form.type.ajax_auto_complete.class' => 'AntQa\\AjaxAutoCompleteBundle\\Form\\Type\\AjaxAutoCompleteType',
