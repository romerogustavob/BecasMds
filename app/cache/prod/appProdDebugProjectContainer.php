...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'becasmds', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_1f90dc7b53eef3c7518083668e1f70f7');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_1f90dc7b53eef3c7518083668e1f70f7');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_1f90dc7b53eef3c7518083668e1f70f7');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\BecasMds\\PersonaBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\BecasMds\\FormacionBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\BecasMds\\BecaBundle\\Entity')));
        ...
        $g->setEntityNamespaces(array('PersonaBundle' => 'BecasMds\\PersonaBundle\\Entity', 'FormacionBundle' => 'BecasMds\\FormacionBundle\\Entity', 'BecaBundle' => 'BecasMds\\BecaBundle\\Entity'));
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.choice'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('choice', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.country'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('country', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.currency'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('currency', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.document'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('document', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.entity'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('entity', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.hidden'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('hidden', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.language'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('language', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.locale'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('locale', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.model'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('model', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.select2.timezone'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\Select2Type('timezone', array('placeholder' => 'Ingrese datos', 'width' => 'off', 'allowClear' => false, 'minimumInputLength' => 3));
    }
    ...
    /**
     * Gets the 'intl.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['lexik_form_filter.apply_filter.doctrine_dbal'] = new \Lexik\Bundle\FormFilterBundle\Event\Listener\DoctrineApplyFilterListener('or');
    }
    ...
    {
        return $this->services['lexik_form_filter.apply_filter.doctrine_orm'] = new \Lexik\Bundle\FormFilterBundle\Event\Listener\DoctrineApplyFilterListener('or');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\lexik\\form-filter-bundle\\Lexik\\Bundle\\FormFilterBundle/Resources/translations\\LexikFormFilterBundle.ru.yml'), 'ru', 'LexikFormFilterBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\lexik\\form-filter-bundle\\Lexik\\Bundle\\FormFilterBundle/Resources/translations\\LexikFormFilterBundle.sk.yml'), 'sk', 'LexikFormFilterBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\lexik\\form-filter-bundle\\Lexik\\Bundle\\FormFilterBundle/Resources/translations\\LexikFormFilterBundle.ua.yml'), 'ua', 'LexikFormFilterBundle');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\jordillonch\\crud-generator\\JordiLlonch\\Bundle\\CrudGeneratorBundle/Resources/translations\\JordiLlonchCrudGeneratorBundle.pt_BR.yml'), 'pt_BR', 'JordiLlonchCrudGeneratorBundle');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\BecasMds\\PersonaBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\BecasMds\\FormacionBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\BecasMds\\BecaBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\BecasMds\\CertificacionBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'debug' => true, 'paths' => array()));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PersonaBundle' => 'BecasMds\\PersonaBundle\\PersonaBundle',
                'FormacionBundle' => 'BecasMds\\FormacionBundle\\FormacionBundle',
                'BecaBundle' => 'BecasMds\\BecaBundle\\BecaBundle',
                'CertificacionBundle' => 'BecasMds\\CertificacionBundle\\CertificacionBundle',
            ...
            'lexik_form_filter.where_method' => 'or',
