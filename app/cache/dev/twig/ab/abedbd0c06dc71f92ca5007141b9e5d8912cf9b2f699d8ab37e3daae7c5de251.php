...
class __TwigTemplate_fe358a338426f919d55d46d066b14fbd9948f53972325becea0760f705e9007e extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("JordiLlonchCrudGeneratorBundle::layout.html.twig", "FormacionBundle:Profesion:show.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("views.show.show", array("%entity%" => "Profesión"), "JordiLlonchCrudGeneratorBundle"), "html", null, true);
        echo "
";
    }
    ...
    public function block_page($context, array $blocks = array())
    {
        // line 8
        echo "
<h2 style=\"color: #0044cc\">Profesión</h2>
...
<div>
    ...
    <div class=\"float-left\">
        ...
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("profesion_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
        echo "\">
            ";
        // line 29
...
";
    ...
    {
        return "FormacionBundle:Profesion:show.html.twig";
    }
...
/* */
/* {% block title %}*/
/* {{ parent() }} - {{ 'views.show.show'|trans({'%entity%': 'Profesión'}, 'JordiLlonchCrudGeneratorBundle') }}*/
/* {% endblock %}*/
/* */
/* {% block page %}*/
/* */
...
/*     </div>*/
/*     <div class="float-left">*/
/*         <a class="btn btn-primary" href="{{ path('profesion_edit', { 'id': entity.id }) }}">*/
