...
/* PersonaBundle:Domicilio:edit.html.twig */
class __TwigTemplate_df27e2c8e3e3ee9246fbe43cb3695604a29d710c7d7b07a2c3d29d833ec7ed46 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("JordiLlonchCrudGeneratorBundle::layout.html.twig", "PersonaBundle:Domicilio:edit.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " -  ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("views.edit.edit", array("%entity%" => "Domicilio"), "JordiLlonchCrudGeneratorBundle"), "html", null, true);
        echo "
";
    }
...
<form class=\"well\" action=\"";
        // line 11
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("domicilio_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "PersonaBundle:Domicilio:edit.html.twig";
    }
...
/* */
/* {% block title %}*/
/* {{ parent() }} -  {{ 'views.edit.edit'|trans({'%entity%': 'Domicilio'}, 'JordiLlonchCrudGeneratorBundle') }}*/
/* {% endblock %}*/
/* */
/* {% block page %}*/
/* */
/* <h2 style="color: #0044cc">{{ 'views.edit.edit'|trans({'%entity%': 'Domicilio'}, 'JordiLlonchCrudGeneratorBundle') }}</h2>*/
/* */
/* <form class="well" action="{{ path('domicilio_update', { 'id': entity.id }) }}" method="post" {{ form_enctype(edit_form) }}>*/
/*     <input type="hidden" name="_method" value="PUT" />*/
