...
/* BecaBundle:TipoBeca:index.html.twig */
class __TwigTemplate_a4877b488f748643440ef8dad2f75eb8e7bbd6735323507d3c22e92fbda86209 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("JordiLlonchCrudGeneratorBundle::layout.html.twig", "BecaBundle:TipoBeca:index.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("views.index.list", array("%entity%" => "TipoBeca"), "JordiLlonchCrudGeneratorBundle"), "html", null, true);
        echo "
";
    }
...
<div class=\"row\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            <td><a href=\"";
            // line 64
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tipobeca_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
        ...
        <a class=\"btn btn-mini\" href=\"";
            // line 72
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tipobeca_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">
            ";
            // line 73
    ...
    <a class=\"btn btn-primary likepaginator\" href=\"";
        // line 86
        echo $this->env->getExtension('routing')->getPath("tipobeca_new");
        echo "\">
            ";
        // line 87
...
";
    ...
    {
        return "BecaBundle:TipoBeca:index.html.twig";
    }
    ...
    {
        return array (  213 => 87,  209 => 86,  202 => 82,  195 => 77,  185 => 73,  181 => 72,  176 => 70,  172 => 69,  163 => 67,  159 => 66,  155 => 65,  149 => 64,  146 => 63,  142 => 62,  135 => 58,  117 => 43,  113 => 42,  107 => 39,  103 => 38,  99 => 37,  95 => 36,  91 => 35,  85 => 34,  73 => 25,  66 => 20,  60 => 17,  57 => 16,  55 => 15,  49 => 12,  43 => 8,  40 => 7,  32 => 4,  29 => 3,  11 => 1,);
    }
}
/* {% extends 'JordiLlonchCrudGeneratorBundle::layout.html.twig' %}*/
/* */
/* {% block title %}*/
/* {{ parent() }} - {{ 'views.index.list'|trans({'%entity%': 'TipoBeca'}, 'JordiLlonchCrudGeneratorBundle') }}*/
/* {% endblock %}*/
/* */
/* {% block page %}*/
/* */
...
/* */
/*     <div class="span8">*/
/*         <h1>{{ 'views.index.list'|trans({'%entity%': 'TipoBeca'}, 'JordiLlonchCrudGeneratorBundle') }}</h1>*/
/*     </div>*/
/*     <div class="span2">*/
...
/*         <div id="filters" class="collapse">*/
/* */
/*             <form class="well" action="{{ path('tipobeca') }}" method="get" {{ form_enctype(filterForm) }}>*/
...
/*         <tr>*/
/*             <td><a href="{{ path('tipobeca_show', { 'id': entity.id }) }}">{{ entity.id }}</a></td>*/
/*             <td>{{ entity.descripcion }}</td>*/
/*             <td>{{ entity.detalle }}</td>*/
/*             <td>{% if entity.activo %} Sí {% else %} No {% endif %}</td>*/
/*             <td>*/
/*         <a class="btn btn-mini" href="{{ path('tipobeca_show', { 'id': entity.id }) }}">*/
/*             {{ 'views.actions.show'|trans({}, 'JordiLlonchCrudGeneratorBundle') }}*/
/*         </a>*/
/*         <a class="btn btn-mini" href="{{ path('tipobeca_edit', { 'id': entity.id }) }}">*/
...
/* */
/*         <div class="span8">*/
/*     <a class="btn btn-primary likepaginator" href="{{ path('tipobeca_new') }}">*/
/*             {{ 'views.index.createnew'|trans({}, 'JordiLlonchCrudGeneratorBundle') }} TipoBeca*/
/*         </a>*/
/*     </div>*/
/*     </div>*/
/* */
