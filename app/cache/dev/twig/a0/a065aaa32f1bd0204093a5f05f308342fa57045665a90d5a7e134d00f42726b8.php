...
/* FormacionBundle:Institucion:show.html.twig */
class __TwigTemplate_5e2e00085e6b704ed0fd8f3a17bfec4a185a74f53a21a22ffe21ebde5f687e88 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("JordiLlonchCrudGeneratorBundle::layout.html.twig", "FormacionBundle:Institucion:show.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("views.show.show", array("%entity%" => "Institución"), "JordiLlonchCrudGeneratorBundle"), "html", null, true);
        echo "
";
    }
    ...
    public function block_page($context, array $blocks = array())
    {
        // line 8
        echo "
<h2 style=\"color: #0044cc\">Institución</h2>
...
<div>
    ...
    <div class=\"float-left\">
        ...
        // line 31
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("institucion_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
        echo "\">
            ";
        // line 32
...
";
    ...
    {
        return "FormacionBundle:Institucion:show.html.twig";
    }
...
/* */
/* {% block title %}*/
/* {{ parent() }} - {{ 'views.show.show'|trans({'%entity%': 'Institución'}, 'JordiLlonchCrudGeneratorBundle') }}*/
/* {% endblock %}*/
/* */
/* {% block page %}*/
/* */
...
/*     </div>*/
/*     <div class="float-left">*/
/*         <a class="btn btn-primary" href="{{ path('institucion_edit', { 'id': entity.id }) }}">*/
