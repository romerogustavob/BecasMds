...
/* PersonaBundle:LugarAfectacion:index.html.twig */
class __TwigTemplate_2acbce53fdb98ad90a46128eda4a4dd87f31e27aba641955543edd86fa5edac1 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("JordiLlonchCrudGeneratorBundle::layout.html.twig", "PersonaBundle:LugarAfectacion:index.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("views.index.list", array("%entity%" => "LugarAfectacion"), "JordiLlonchCrudGeneratorBundle"), "html", null, true);
        echo "
";
    }
...
<div class=\"row\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            <td><a href=\"";
            // line 62
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("lugarafectacion_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
        ...
        <a class=\"btn btn-mini\" href=\"";
            // line 69
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("lugarafectacion_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">
            ";
            // line 70
    ...
    <a class=\"btn btn-primary likepaginator\" href=\"";
        // line 83
        echo $this->env->getExtension('routing')->getPath("lugarafectacion_new");
        echo "\">
            ";
        // line 84
...
";
    ...
    {
        return "PersonaBundle:LugarAfectacion:index.html.twig";
    }
...
/* */
/* {% block title %}*/
/* {{ parent() }} - {{ 'views.index.list'|trans({'%entity%': 'LugarAfectacion'}, 'JordiLlonchCrudGeneratorBundle') }}*/
/* {% endblock %}*/
/* */
/* {% block page %}*/
/* */
...
/* */
/*     <div class="span8">*/
/*         <h2 style="color: #0044cc">{{ 'views.index.list'|trans({'%entity%': 'LugarAfectacion'}, 'JordiLlonchCrudGeneratorBundle') }}</h2>*/
/*     </div>*/
/*     <div class="span2">*/
...
/*         <div id="filters" class="collapse">*/
/* */
/*             <form class="well" action="{{ path('lugarafectacion') }}" method="get" {{ form_enctype(filterForm) }}>*/
...
/*         <tr>*/
/*             <td><a href="{{ path('lugarafectacion_show', { 'id': entity.id }) }}">{{ entity.id }}</a></td>*/
/*             <td>{{ entity.nombre }}</td>*/
/*             <td>{{ entity.descripcion }}</td>*/
/*             <td>*/
/*         <a class="btn btn-mini" href="{{ path('lugarafectacion_show', { 'id': entity.id }) }}">*/
/*             {{ 'views.actions.show'|trans({}, 'JordiLlonchCrudGeneratorBundle') }}*/
/*         </a>*/
/*         <a class="btn btn-mini" href="{{ path('lugarafectacion_edit', { 'id': entity.id }) }}">*/
...
/* */
/*         <div class="span8">*/
/*     <a class="btn btn-primary likepaginator" href="{{ path('lugarafectacion_new') }}">*/
/*             {{ 'views.index.createnew'|trans({}, 'JordiLlonchCrudGeneratorBundle') }} LugarAfectacion*/
/*         </a>*/
/*     </div>*/
/*     </div>*/
/* */
