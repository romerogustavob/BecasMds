...
/* PersonaBundle:Departamento:index.html.twig */
class __TwigTemplate_b8c72157e939a2e937d43b5011a6f00ad4bde4f011d37ad46d4145c239c33a4b extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("JordiLlonchCrudGeneratorBundle::layout.html.twig", "PersonaBundle:Departamento:index.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("views.index.list", array("%entity%" => "Departamento"), "JordiLlonchCrudGeneratorBundle"), "html", null, true);
        echo "
";
    }
...
";
    ...
    {
        return "PersonaBundle:Departamento:index.html.twig";
    }
...
/* */
/* {% block title %}*/
/* {{ parent() }} - {{ 'views.index.list'|trans({'%entity%': 'Departamento'}, 'JordiLlonchCrudGeneratorBundle') }}*/
/* {% endblock %}*/
/* */
/* {% block page %}*/
/* */
...
/* */
/*     <div class="span8">*/
/*         <h2 style="color: #0044cc">{{ 'views.index.list'|trans({'%entity%': 'Departamento'}, 'JordiLlonchCrudGeneratorBundle') }}</h2>*/
/*     </div>*/
/*     <div class="span2">*/
...
/*         <div id="filters" class="collapse">*/
/* */
/*             <form class="well" action="{{ path('departamento') }}" method="get" {{ form_enctype(filterForm) }}>*/
...
/*         <tr>*/
/*             <td><a href="{{ path('departamento_show', { 'id': entity.id }) }}">{{ entity.id }}</a></td>*/
/*             <td>{{ entity.nombre }}</td>*/
/*             <td>{{ entity.descripcion }}</td>*/
/*             <td>*/
/*         <a class="btn btn-mini" href="{{ path('departamento_show', { 'id': entity.id }) }}">*/
/*             {{ 'views.actions.show'|trans({}, 'JordiLlonchCrudGeneratorBundle') }}*/
/*         </a>*/
/*         <a class="btn btn-mini" href="{{ path('departamento_edit', { 'id': entity.id }) }}">*/
...
/* */
/*         <div class="span8">*/
/*     <a class="btn btn-primary likepaginator" href="{{ path('departamento_new') }}">*/
/*             {{ 'views.index.createnew'|trans({}, 'JordiLlonchCrudGeneratorBundle') }} Departamento*/
/*         </a>*/
/*     </div>*/
/*     </div>*/
/* */
